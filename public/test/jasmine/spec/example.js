describe("dependencies", function() {
    describe("testing with jQuery", function() {
        it("is jaqk", function() {
            expect($('#ok').html()).toEqual('1');
        });
    });

    describe("testing with lodash", function() {
        it("is mapness", function() {
            expect(_.map([0, 1, 2], function(num) {
                return ++num;
            })).toEqual([1, 2, 3]);
        });
    });
